...
public class MultiSelectionSpinner extends AppCompatSpinner implements
    ...
    ArrayList<FacilitiyType> facilitiyTypes = null;
    ...
    public void setItems(ArrayList<FacilitiyType> facilitiyTypes) {
        this.facilitiyTypes = facilitiyTypes;
    ...
    public void setSelection(ArrayList<FacilitiyType> selection) {
...
//        }
    ...
    public ArrayList<FacilitiyType> getSelectedFacilitiyTypes() {
        ArrayList<FacilitiyType> selectedFacilitiyTypes = new ArrayList<>();
