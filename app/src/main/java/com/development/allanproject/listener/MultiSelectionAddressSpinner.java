...
public class MultiSelectionAddressSpinner extends AppCompatSpinner implements
        DialogInterface.OnMultiChoiceClickListener {

    ArrayList<Addres> facilitiyTypes = null;
    boolean[] selection = null;
    ArrayAdapter adapter;

    public MultiSelectionAddressSpinner(Context context) {
        super(context);
    ...
    public MultiSelectionAddressSpinner(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public void setItems(ArrayList<Addres> Addres) {
    ...
    public void setSelection(ArrayList<Addres> selection) {
...
//        }
    ...
    public ArrayList<Addres> getSelectedFacilitiyTypes() {
        ArrayList<Addres> selectedFacilitiyTypes = new ArrayList<>();
