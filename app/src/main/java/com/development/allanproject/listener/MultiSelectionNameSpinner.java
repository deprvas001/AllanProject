...
import com.development.allanproject.model.preferenceModel.FacilitiyName;
import com.development.allanproject.model.preferenceModel.FacilitiyType;

import java.util.ArrayList;
import java.util.Arrays;

public class MultiSelectionNameSpinner extends AppCompatSpinner implements
        DialogInterface.OnMultiChoiceClickListener {

    ArrayList<FacilitiyName> facilitiyTypes = null;
    boolean[] selection = null;
    ArrayAdapter adapter;

    public MultiSelectionNameSpinner(Context context) {
        super(context);
    ...
    public MultiSelectionNameSpinner(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public void setItems(ArrayList<FacilitiyName> facilitiyName) {
        this.facilitiyTypes = facilitiyName;
    ...
    public void setSelection(ArrayList<FacilitiyName> selection) {
...
//        }
    ...
    public ArrayList<FacilitiyName> getSelectedFacilitiyTypes() {
        ArrayList<FacilitiyName> selectedFacilitiyTypes = new ArrayList<>();
