...
import com.development.allanproject.model.preferenceModel.ShiftType;

import java.util.ArrayList;
import java.util.Arrays;

public class MultiSelectionShiftSpinner extends AppCompatSpinner implements
        DialogInterface.OnMultiChoiceClickListener {

    ArrayList<ShiftType> facilitiyTypes = null;
    boolean[] selection = null;
    ArrayAdapter adapter;

    public MultiSelectionShiftSpinner(Context context) {
        super(context);
    ...
    public MultiSelectionShiftSpinner(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public void setItems(ArrayList<ShiftType> ShiftType) {
        this.facilitiyTypes = ShiftType;
    ...
    public void setSelection(ArrayList<ShiftType> selection) {
...
//        }
    ...
    public ArrayList<ShiftType> getSelectedFacilitiyTypes() {
        ArrayList<ShiftType> selectedFacilitiyTypes = new ArrayList<>();
