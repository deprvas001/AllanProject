...
public class OpenShiftListItemAdapter extends RecyclerView.Adapter<OpenShiftListItemAdapter.MyViewHolder> {
    ...
    public OpenShiftListItemAdapter(Context context,ArrayList<DateShiftData> shiftList) {
        this.context = context;
        this.shiftList = shiftList;
    }

    @Override
    public OpenShiftListItemAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.hidden_job_riow, parent, false);

        return new OpenShiftListItemAdapter.MyViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(OpenShiftListItemAdapter.MyViewHolder holder, int position) {
