...
import com.development.allanproject.views.activity.ui.viewPastShift.ViewPastShift;

import java.util.ArrayList;

public class PastShiftAdapter extends RecyclerView.Adapter<PastShiftAdapter.MyViewHolder> {
    ...
    public PastShiftAdapter(Context context, ArrayList<ShiftItem> shiftList) {
        this.context = context;
        this.shiftList = shiftList;
    }

    @Override
    public PastShiftAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.past_shift_row, parent, false);

        return new PastShiftAdapter.MyViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(PastShiftAdapter.MyViewHolder holder, int position) {
        ...
        holder.cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(context, ViewPastShift.class);
