package com.development.allanproject.downloadfile;
        ...
        protected void onPostExecute(Void result) {
            try {
                if (outputFile != null) {
                    ...
                    ContextThemeWrapper ctw = new ContextThemeWrapper(context, android.R.style.Theme_Material_Light_Dialog);
                    ...
                    alertDialogBuilder.setNegativeButton("Open", new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int id) {
                            ...
                            Uri photoURI = FileProvider.getUriForFile(context, context.getApplicationContext().getPackageName() + ".provider", pdfFile);
