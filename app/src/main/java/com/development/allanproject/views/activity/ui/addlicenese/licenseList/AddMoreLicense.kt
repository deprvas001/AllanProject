...
import com.development.allanproject.databinding.ActivityAddMoreLicenseBinding
...
class AddMoreLicense : AppCompatActivity() , AuthListener, KodeinAware, View.OnClickListener {
    ...
    private lateinit var binding: ActivityAddMoreLicenseBinding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = DataBindingUtil.setContentView(this,R.layout.activity_add_more_license)
        ...
        binding.btnNext.setOnClickListener {
            ...
            viewModel.updateLicense(header,licenseRequest,"create")
