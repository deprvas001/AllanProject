...
import com.development.allanproject.databinding.ActivityAwardsScreenBinding;
...
public class AwardsScreen extends BaseActivity implements View.OnClickListener {
ActivityAwardsScreenBinding screenBinding;
    AwardAdapter adapter;
    RecyclerView.LayoutManager mLayoutManager;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        screenBinding = DataBindingUtil.setContentView(this,R.layout.activity_awards_screen);
        setClickListener();
     }
